...
public class HelpMethods {
    ...
    public static float GetEnityXPosUnderRoofOrAboveFloor(Rectangle2D.Float hitbox, float airSpeed){
    ...
    public static boolean IsEnityOnFloor(Rectangle2D.Float hitbox, int[][] lvlData){
